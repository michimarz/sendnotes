...
<div>
    <form wire:submit='submit' class="space-y-4">
        ...
        <x-textarea wire:model='noteBody' label="Your Note" placeholder="Your note here" />
        <x-input icon="user" wire:model='noteRecipient' 
            label='Recipient' placeholder="yourfriend@email.com" type="email" />
